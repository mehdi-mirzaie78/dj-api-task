...
class EstimateSerializer(serializers.ModelSerializer):
    ...
    equipments_list = EstimateEquipmentSerializer(
        source="estimateequipment_set", read_only=True, many=True
    )
    ...
    def create(self, validated_data):
        ...
        with transaction.atomic():
            ...
            equipment_instances = [
                EstimateEquipment(estimate=estimate, **equipment_data)
    ...
    def update(self, instance, validated_data):
        ...
        with transaction.atomic():
            ...
            self.existing_equipments_map = {
                item.id: item for item in self.current_equipments
            }
    ...
    def _update_existing_items_or_create_new_items(self, instance):
        for equipment_data in self.equipments_data:
            ...
            if equipment_id and equipment_id in self.existing_equipments_map:
                ...
                equipment_instance.price_override = equipment_data.get(
                    "price_override", equipment_instance.price_override
                )
